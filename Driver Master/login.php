  ...
  <form method="post" action="login.php"> 
      ...
      <button type="button" onclick="document.getElementById('contact').style.display='none'" class="cancelbtn">Cancel</button>
		...
		<div class="background">
			...
			<p>Vrei sa obtii permisul de conducere sau sa conduci intr-o tara straina si trebuie sa iti actualizezi cunostintele despre legislatie si indicatoare rutiere?<br> Acum poti sa iti testezi si imbogatesti cunostintele!</p>
